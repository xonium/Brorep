...
import { IdentityClient, SeasonClient, WorkoutClient, JudgingClient } from './brorep-api';
...
@NgModule({
  ...
  providers: [IdentityClient, JwtService, UserService, SeasonClient, WorkoutClient, JudgingClient, {
