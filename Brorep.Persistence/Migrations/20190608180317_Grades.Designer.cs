...
namespace Brorep.Persistence.Migrations
{
    ...
    [Migration("20190608180317_Grades")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Brorep.Domain.Entities.Grade", b =>
                {
            ...
            modelBuilder.Entity("Brorep.Domain.Entities.JudgingType", b =>
                {
                    b.Property<Guid>("JudgingTypeId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.HasKey("JudgingTypeId");

                    b.ToTable("JudgingTypes");
                });
            ...
            modelBuilder.Entity("Brorep.Domain.Entities.Grade", b =>
                {
                    b.HasOne("Brorep.Domain.Entities.ApplicationUser", "Judge")
                        .WithMany()
            ...
            modelBuilder.Entity("Brorep.Domain.Entities.Rep", b =>
                {
                    b.HasOne("Brorep.Domain.Entities.Submission", null)
                        .WithMany("Reps")
            ...
            modelBuilder.Entity("Brorep.Domain.Entities.Workout", b =>
                {
                    b.HasOne("Brorep.Domain.Entities.Season", null)
                        .WithMany("Workouts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Brorep.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
